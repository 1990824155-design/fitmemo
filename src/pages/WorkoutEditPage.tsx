      ...
      <main className="bg-surface px-page pb-6">
        <div className="flex flex-col space-y-3 pt-6 pb-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <label className="flex min-w-0 flex-1 items-center gap-2 overflow-hidden rounded-xl bg-surface-container-low px-3 py-2">
              <Icon name="calendar_month" className="shrink-0 text-on-surface-variant" />
              <input
                type="date"
                className="box-border min-w-0 max-w-full flex-1 bg-transparent text-sm outline-none"
                value={workout.date}
                onChange={(e) => {
